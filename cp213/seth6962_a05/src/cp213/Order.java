...
public class Order implements Printable {
	...
	// your code here
        ...
        for (MenuItem item : map.keySet()) {
            ...
            subtotal = subtotal.add(item.getTariff().multiply(BigDecimal.valueOf(quantity)));
        }
	...
	// your code here
    	BigDecimal tax = new BigDecimal(this.getSubTotal().doubleValue() * TAX_RATE.doubleValue());
	...
	// your code here
    	String ret = "";
    	for(MenuItem i : map.keySet()) {
    		ret += lineFormat.formatted(i.getName(), map.get(i), i.getTariff(), (i.getTariff().floatValue()*map.get(i)));
    	}
    	
    	ret += totalFormat.formatted("Subtotal", this.getSubTotal().floatValue());
    	ret += totalFormat.formatted("Taxes", this.getTaxes().floatValue());
    	ret += totalFormat.formatted("Total", this.getTotal().floatValue());	
	return ret;
    }
