...
public class FoodUtilities {
	...
	// your code here
    	...
    	if(b.equalsIgnoreCase("Y"))
    		food.setVegitarian(true);
    	if(b.matches("N")) 
    		food.setVegitarian(false);
    	
    	System.out.println("Calories:   ");
    	food.setCalories(keyboard.nextInt());
	...
	// your code here
    	...
    	int origin = Integer.parseInt(delim[1]);
    	boolean veg = Boolean.parseBoolean(delim[2]);
    	int cal = Integer.parseInt(delim[3]);
    	
    	food.setName(delim[0]);
    	food.setOrigin(origin);
    	food.setVegitarian(veg);
	...
	// your code here
    	ArrayList<Food> matchedfood = new ArrayList<Food>();
    	
    	for(Food food: foods) {
    		if(food.getCalories() == maxCalories && 
    		   food.getOrigin() == origin && 
    		   food.isVegetarian() == isVegetarian) {
    			matchedfood.add(food);
    		}
    	}
