...
public class RTSameView extends JPanel {
	...
	public void actionPerformed(final ActionEvent evt) {
		...
		if(direction == 0) {
			...
			double val = RTSameView.this.model.getHeight() - RTSameView.this.model.getBase();
			
			val /= 2;
			
			double new_val = RTSameView.this.model.getHeight() - val;
			
			RTSameView.this.model.setBase(new_val);
			RTSameView.this.model.setHeight(new_val);
		}
		if(direction == 1) {
			RTSameView.this.model.setBase(RTSameView.this.model.getBase() + 1);
			RTSameView.this.model.setHeight(RTSameView.this.model.getHeight() + 1);
		}
		if(direction == -1) {
			RTSameView.this.model.setBase(RTSameView.this.model.getBase() - 1);
			RTSameView.this.model.setHeight(RTSameView.this.model.getHeight() - 1);
	...
	public void propertyChange(final PropertyChangeEvent evt) {
		...
		if(RTSameView.this.model.getBase() == RTSameView.this.model.getHeight()) {
			baseHeight.setText(DECIMAL_FORMAT.format(RTSameView.this.model.getBase()));
		} else {
			baseHeight.setText("");
		}
		hypo.setText(DECIMAL_FORMAT.format(RTSameView.this.model.getHypotenuse()));
